//
//  YuyuEmotionalEmissionView.swift
//  SymbolKanojo
//
...
struct YuyuEmotionalEmissionView: EmotionalEmissionView {
    @ObservedObject private var vm: YuyuEmotionalEmissionViewModel
    ...
    init(vm: YuyuEmotionalEmissionViewModel) {
        self.vm = vm
...
private extension YuyuEmotionalEmissionView {
...
#Preview {
    YuyuEmotionalEmissionView(vm: .init())
}
