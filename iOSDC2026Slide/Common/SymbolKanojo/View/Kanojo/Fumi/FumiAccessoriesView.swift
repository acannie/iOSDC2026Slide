...
struct FumiAccessoriesView: AccessoriesView {
    @ObservedObject private var vm: FumiAccessoriesViewModel
    ...
    init(vm: FumiAccessoriesViewModel) {
        self.vm = vm
    }
...
private extension FumiAccessoriesView {
