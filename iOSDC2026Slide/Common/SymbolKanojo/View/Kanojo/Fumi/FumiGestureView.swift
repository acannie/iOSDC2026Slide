...
struct FumiGestureView: GestureView {
    @ObservedObject var vm: FumiGestureViewModel

    private let skinColor = Color("fumi_skin")
    private let skinColorMiddle = Color("fumi_skin_middle")
    private let nailColor = Color("fumi_nail")
...
private extension FumiGestureView {
    @ViewBuilder
