...
struct FumiEyesView: EyesView {
    @ObservedObject var vm: FumiEyesViewModel

    private let whiteOfEyesColor = Color("fumi_whiteOfEyes")
    private let irisColorMiddle = Color("fumi_iris_middle")
    private let irisColorLight = Color("fumi_iris_light")
    private let eyelashColor = Color("fumi_eyelash")
    private let skinColorLight = Color("fumi_skin_light")
    private let skinColorDark = Color("fumi_skin_dark")
    private let eyeDizzyColor = Color("fumi_eyeDizzy")
    private let eyeHeartColor = Color("fumi_eyeHeart")
    private let eyeShineColor = Color("fumi_eyeShine")
    private let eyeDollarColor = Color("fumi_eyeDollar")
    private let eyeStarColor = Color("fumi_eyeStar")
    private let eyeKnockoutColor = Color("fumi_eyeKnockout")
...
private extension FumiEyesView {
    @ViewBuilder
    ...
    func closedEye(side: Side) -> some View {
        ZStack {
            ...
            Image(systemName: "field.of.view.ultrawide.fill")
                ...
                .foregroundStyle(
                    LinearGradient(
                        colors: [skinColorLight, skinColorDark],
    ...
    func xmark(side: Side) -> some View {
        Image(systemName: "cross.fill")
            ...
            .foregroundStyle(eyeKnockoutColor)
            .ios18Animation(.bounce)
    }
    ...
    func dollar(side: Side) -> some View {
        Image(systemName: "dollarsign")
            ...
            .foregroundStyle(eyeDollarColor)
            .ios18Animation(.bounce)
    }
    ...
    var defaultIris: some View {
        Image(systemName: "person.crop.circle.fill")
            ...
            .foregroundStyle(
                LinearGradient(
                    gradient: Gradient(colors: [irisColorMiddle, irisColorLight]),
                    startPoint: .top,
                    endPoint: .bottom
                )
            )
