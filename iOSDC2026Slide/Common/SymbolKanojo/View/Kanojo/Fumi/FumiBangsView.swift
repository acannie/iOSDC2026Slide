...
struct FumiBangsView: BangsView {
    private let bangsColor = Color("fumi_frontHair")
    private let animalEarPink = Color("fumi_animalEarPink")
    private let animalEarGray = Color("fumi_animalEarGray")
