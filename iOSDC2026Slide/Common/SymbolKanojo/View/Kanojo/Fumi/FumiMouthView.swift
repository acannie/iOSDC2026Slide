...
struct FumiMouthView: MouthView {
    @ObservedObject var vm: FumiMouthViewModel
    ...
    private let mouthColor = Color("fumi_mouth")
    private let tongueColorLight = Color("fumi_tongue_light")
    private let tongueColorDark = Color("fumi_tongue_dark")
    private let toothColorLight = Color("fumi_tooth_light")
    private let toothColorDark = Color("fumi_tooth_dark")
...
private extension FumiMouthView {
    ...
    func smileMischievously(size: MouthType.MouthSize) -> some View {
        ...
        return ZStack {
            Image(systemName: "externaldrive.fill")
                .resizable()
                .foregroundStyle(toothColorLight)
            Image(systemName: "externaldrive")
                .resizable()
                .foregroundStyle(toothColorDark)
        }
    ...
    var tongue: some View {
        ...
        return ZStack {
            Image(systemName: "hockey.puck.fill")
                .resizable()
                .foregroundStyle(tongueColorLight)
                .frame(width: width, height: 25)
            Image(systemName: "hockey.puck")
                .resizable()
                .fontWeight(.bold)
                .foregroundStyle(tongueColorDark)
                .frame(width: width, height: 25)
        }
        .rotationEffect(angle)
