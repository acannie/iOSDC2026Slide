...
private extension WindowView {
    ...
    var stainedGlassTriangle: some View {
        func coloredLayer(isPlantColor: Bool) -> some View {
            ZStack {
        ...
        return ZStack {
            ...
            .padding(20)
            HStack {
                coloredLayer(isPlantColor: false)
                    .rotationEffect(.degrees(90))
                Spacer()
                VStack {
                    coloredLayer(isPlantColor: false)
                        .rotationEffect(.degrees(180))
                    Spacer()
                    coloredLayer(isPlantColor: true)
                }
                Spacer()
                coloredLayer(isPlantColor: false)
